...
- For `sizes`, send a JSON array string (e.g. `[{"size":"half","price":7.99,"is_default":false},{"size":"small","price":10.99,"is_default":false},{"size":"extra_large","price":22.99,"is_default":false}]`).
